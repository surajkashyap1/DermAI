...
- Vision: local HAM10000-based skin-lesion model loaded from Hugging Face
...
- The first image upload can be slower because the local vision model is downloaded and cached on first use.
